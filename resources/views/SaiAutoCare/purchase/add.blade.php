      ...
      <div class="row">
        ...
        <div class="col-md-4">
         ...
         <div class="col-md-4">
          ...
          {{Form::text('bill_date',isset($bill_date)?$bill_date: '', ['class' => 'form-control form-control ', 'placeholder' => 'Bill Date','id'=>'billDate','data-date-format'=>'DD-MM-YYYY HH:mm:ss'] )}}
          <div class="invalid-feedback">
                ...
                <table id="addmoretable" class="table table-bordered">
                  <thead>
                    <tr>
                     ...
                     <th style="white-space: nowrap" >Model Name  &emsp;&emsp; &emsp;&emsp;&emsp;</th>
                     <th style="white-space: nowrap" >Spare Name &emsp;&emsp; &emsp;&emsp;&emsp;</th>
                     ...
                     <th style="white-space: nowrap" >HSN&emsp;&emsp;&emsp; &emsp;</th>
                     <th style="white-space: nowrap" >Unit Price &emsp;&emsp; &emsp;</th>
                     <th style="white-space: nowrap" >Unit Price Exit &emsp;&emsp; &emsp;</th>
                     <th style="white-space: nowrap" >Qty &emsp;&emsp;&emsp;&emsp; &emsp;</th>
                     <th style="white-space: nowrap" >GST &emsp;&emsp;</th>
                     <!-- <th style="white-space: nowrap" >Discount</th> -->
                     <th style="white-space: nowrap" >TAmount &emsp;&emsp; &emsp;&emsp;&emsp; &emsp;</th>
                       @php
                        if(!isset($id))
                        {
                          echo "<th>";
                  ...
                  <tbody id="tBody">
                    <tr id="addRow">
                      ...
                      <td  class="company_name">{{Form::select('company_name[]', $brand_select,isset($company_name)?$company_name: '', ['class' => 'form-control single-select selectToP1', isset($id)?'disabled="true"':'','id' => 'Brand Name'])}}
                      </td>
                       <td class="model_number">{{Form::select('model_number[]',$model_select, isset($model_number)?$model_number: '', ['class' => 'form-control selectToP2 ',isset($id)?'disabled="true"':'', 'id' => 'model_number'])}}
                      </td>
                      <td  class="product_name">{{Form::select('product_id[]',$product, isset($product_id)?$product_id: '', ['class' => 'form-control selectToJ1','required'=>'true',isset($id)?'disabled="true"':'','placeholder'=>'Select' ,'id' => 'product_id'])}}
                        @if(isset($id))
                      ...
                      <td class="unit_price">{{Form::text('unit_price[]', isset($unit_price)?$unit_price: '', ['class' => 'form-control ','min-width'=>'30px' ,'id' => 'unit_price','step'=>'any'])}}
                      </td>
                       <td class="unit_price_exit">{{Form::text('unit_price_exit[]', isset($unit_price_exit)?$unit_price_exit: '', ['class' => 'form-control ', 'id' => 'unit_price_exit','step'=>'any'])}}
                      </td>
                      <td class="quantity">{{Form::text('quantity[]', isset($quantity)?$quantity: '', ['class' => 'form-control qtn', 'id' => 'quantity',isset($id)?'readonly':'','step'=>'any','required'=>'required'])}}
                      </td>
                      <td class="gst">{{Form::text('gst[]', isset($gst)?$gst: '', ['class' => 'form-control ', 'id' => 'gst','step'=>'any'])}}
                      </td>
      ...
      $('.addMore').on("click",function(){
        i=parseFloat(i)+1;
         $("#tBody").append('<tr id="AddRow'+i+'">\
                    <td class="company_name">{{Form::select("company_name[]", $brand_select,"", ["class" => "form-control selectToP1 single-select", "id" => "company_name"])}}\
                    </td>\
                    <td class="model_number">{{Form::select("model_number[]",$model_select,"" ,["class" => "form-control selectToP2 ", "id" => "model_number",])}}\
                    </td>\
                    <td class="product_name">{{Form::select("product_id[]", $product,"" ,["class" => "form-control selectToJ1","placeholder"=>"Select" ,"required"=>"true", "id" => "product_id"])}}\
                    </td>\
