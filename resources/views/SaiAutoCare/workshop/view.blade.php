	...
	<section style="margin-left: 30px;margin-right: 30px; margin-top: 30px">
		<div style="height:80px;width:100% ;background-color: white;" class="grid-container">
			...
			<div  class="grid-item " align="right">
				...
				<div style="width:100%;text-shadow: 3px 2px red;" align="right" class="logo"><b><i>Sai Auto Care</i></b></div>
			</div>
		...
		<div style="width:100% ;background-color: white;" class="grid-container2"  >
			...
			<div  class="grid-item" style="font-size: 17px" align="left">
				<table>
					...
					<tr  align="left">
						<td  style="white-space: nowrap">Alt Phone Number</td>
						<td>:&nbsp;</td>
			...
			<div  class="grid-item" style="font-size: 18px">
						<table >
								...
								<tr>
							   	...
							   	<tr>
							   		<td>&nbsp;</td>
							   		<td style="white-space: nowrap" align="left">Down Payment</td>
							   		<td>:&nbsp;</td>
			   ...
			   @endphp
				...
				<tr><td>
					<table    width="100%" border="1">	
						...
						<tr><td colspan="5" align="right" ><b>Grand Total Price :</b> {{ $total_product_price+$total_service_price }}</td>
...
$numberTransformer = $numberToWords->getNumberTransformer('en');
					...
					@endphp
					<tr><td colspan="5"  ><p><b>Rupees:</b> {{ $numberTransformer->toWords($total_product_price+$total_service_price) }}
						@php
						if($is_complete==0)
						{
