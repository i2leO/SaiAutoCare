                 ...
                 @else
                  <tr class="estimatedCost" >
                    ...
                    <td>
                      ...
                      <td  class="service_name">{{Form::select('product_id[]',$product, isset($product_id)?$product_id: '', ['class' =>  'form-control selectToJ1','required'=>'true','placeholder'=>'Select' ])}}
                      </td>
                      <td>
  ...
  //  $('#docForProduct').toggle();
    ...
    $('.addMoreForProduct_es').on("click",function(){
        i=parseFloat(i)+1;
          ...
          <td><input type="number" id="product_price" name="product_price_es[]" class="form-control" required="true"></div>\
          </td>\
          <td>\
