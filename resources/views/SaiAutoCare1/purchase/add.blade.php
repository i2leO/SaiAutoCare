                ...
                <table id="addmoretable" class="table table-bordered">
                  ...
                  <tbody id="tBody">
                    <tr id="addRow">
                      ...
                      <td class="unit_price">{{Form::text('unit_price[]', isset($unit_price)?$unit_price: '', ['class' => 'form-control ','min-width'=>'30px' ,'id' => 'unit_price','step'=>'0.01'])}}
                      </td>
                       <td class="unit_price_exit">{{Form::text('unit_price_exit[]', isset($unit_price_exit)?$unit_price_exit: '', ['class' => 'form-control ', 'id' => 'unit_price_exit','step'=>'0.01'])}}
                      </td>
                      <td class="quantity">{{Form::text('quantity[]', isset($quantity)?$quantity: '', ['class' => 'form-control qtn', 'id' => 'quantity',isset($id)?'readonly':'','step'=>'0.01'])}}
                      </td>
                      <td class="gst">{{Form::text('gst[]', isset($gst)?$gst: '', ['class' => 'form-control ', 'id' => 'gst','step'=>'0.01'])}}
                      </td>
      ...
      $('.addMore').on("click",function(){
        i=parseFloat(i)+1;
         $("#tBody").append('<tr id="AddRow'+i+'">\
                    ...
                    <td class="quantity">{{Form::text("quantity[]", "", ["class" => "form-control qtn", "id" => "quantity","step"=>"0.01"])}}\
                    </td>\
       ...
       $(document).on('click', '.removeRow', function(){  
        ...
        $(document).on("change click","[name^=company_name]",function(){
          var thisSelf=$(this);
      var brand = $(this).val();
      $.ajax({
        type:"POST",
