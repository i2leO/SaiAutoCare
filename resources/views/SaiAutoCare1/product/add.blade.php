      ...
      <div class="row">
        ...
        <div class="col-md-3">
         ...
         <div class="col-md-3">
          ...
          {{Form::number('unit_price_exit',isset($unit_price_exit)?$unit_price_exit: '', ['class' => 'form-control form-control ', 'placeholder' => 'Unit Exit Price'] )}}
          <div class="invalid-feedback">
        ...
        <div class="col-md-3">
          ...
          {{Form::number('gst',isset($gst)?$gst: 0, ['class' => 'form-control form-control ', 'placeholder' => 'GST'] )}}
          <div class="invalid-feedback">
